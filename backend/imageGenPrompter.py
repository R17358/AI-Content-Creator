...
# add this line when want  to set more number of images or length
    ...
    IMPORTANT: Number of Prompts should be {numOfPrompts}
    ...
    **Format:**  
    ...
    - `camera_movement`: **Dynamic motion of the scene (e.g., slow pan, zoom-in, ripple, parallax, handheld, fade, cross fade, whip left etc).**
