...
def create_video(image_paths, output_path, image_duration_list=[], transition_list=[], video_length=30, fps=30, transition_duration=1.5):
    ...
    if not image_duration_list:
        image_duration_list = [2] * (len(image_paths) )

    if not transition_list:
        transition_list = ["cross fade"] * (len(image_paths) - 1)
...
# # **Example Usage**
# image_paths = ["sample_test/Buddha.webp","sample_test/doraemon.webp", "sample_test/durga ma.webp", "sample_test/krishna.webp", "sample_test/mogli.webp", "sample_test/santa.webp", "sample_test/shiva.webp", "sample_test/Tom Jerry.webp", "sample_test/mogli.webp", "sample_test/santa.webp", "sample_test/shiva.webp", "sample_test/Tom Jerry.webp"]
# transition_list = ["fade in", "ripple","fade to black", "dissolve", "glitch","zoom in", "zoom out","wipe left", "wipe up","whip left", "cross fade", "fade to black"]  # Ensure list has correct transitions
# image_duration_list = [4.0, 4, 4, 4.2, 4, 4, 4, 4, 4, 4, 4, 4]
# output_path = "Generated_video/video.mp4"

# out = create_video(image_paths, output_path, image_duration_list, transition_list)
# print(out)